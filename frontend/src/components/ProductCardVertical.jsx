...
const ProductCardVertical = ({ category, mainText, boldText }) => {
  ...
  return (
    <div className=" container mx-auto px-4 lg:px-5 my-6 relative ">
      ...
      <div
        className="flex items-center gap-4 lg:ml-5 md:gap-6 overflow-x-scroll scrollbarHide transition-all duration-1000 scroll-smooth"
        ref={scrollElement}
      >
        <button
          ...
          ? cardSkeleton.map((_, index) => {
              return (
                <div
                  ...
                  className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-fit bg-white rounded-sm shadow"
                >
          ...
          : data.map((product, index) => {
              return (
                <Link
                  ...
                  key={product?._id}
                  className="w-full min-w-[285px] md:min-w-[330px] max-w-[285px] md:max-w-[330px] bg-white rounded shadow"
                >
                  <div className="bg-slate-200 h-52 p-4 min-w-[285px] md:min-w-[145px] flex justify-center items-center ">
                    <img
