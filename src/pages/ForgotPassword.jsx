...
const ForgetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const userData = await fetch(apiCalls.resetPassword.url, {
      method: apiCalls.resetPassword.method,
      headers: {
      ...
      <div className="mx-auto container p-4 lg:px-8">
        <div className="w-full max-w-md mx-auto bg-white p-5 rounded ">
          ...
          <form className="pt-6 flex flex-col gap-2" onSubmit={handleSubmit}>
            ...
            <button className="bg-red-600 hover:bg-red-700 text-white px-2 py-2 w-full max-w-[160px] rounded-full hover:scale-110 transition-all mx-auto block mt-6">
              Reset Password
            </button>
          </form>
